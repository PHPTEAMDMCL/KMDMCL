...
html(lang="vi-VN")
	head
		title Mua hàng online - Săn Coupon giảm đến 10% | Điện Máy Chợ Lớn
		meta(http-equiv='content-type' content='text/html; charset=utf-8')
		meta(name='author' content=' Siêu thị điện máy Chợ Lớn ')
		meta(name='viewport' content='width=device-width, initial-scale=1')
		meta(name='description' content='Mua hàng mua online săn mã giảm giá lên đến 10% sản phẩm máy giặt, tủ lạnh áp dụng đến 25/01/2019 tại Siêu thị điện máy Chợ Lớn')
		meta(name='Author' content='Siêu thị Điện máy Chợ Lớn')
		...
		meta(property='og:title' content='Mua hàng online - săn coupon giảm đến 10% tại Siêu thị điện máy Chợ Lớn')
		meta(property='og:description' content='Mua online săn mã giảm giá đến 10% các sản phẩm máy giặt, tủ lạnh kèm nhiều quà tặng hấp dẫn áp dụng đến hết 25/01/2019 tại Siêu thị điện máy Chợ Lớn')
					...
					ul.list_product
						...
						li
							a.img_pro(href="https://dienmaycholon.vn/".$p->Product()->Cate()['alias']."/".$p->Product()['alias'] , target="_blank")
								...
								img(src='https://dienmaycholon.vn/public/picture/icon/icon_desktop_3_1547193856.png' class="icon_left")
								@endif
								@if(!empty($p['is_red_day']==4))
								img(src='https://dienmaycholon.vn/public/picture/icon/icon_desktop_4_1547278469.png' class="icon_left")
								@endif
								@if(!empty($p['is_price']==1))
								img(src='https://dienmaycholon.vn/public/picture/icon/icon_desktop_9_1547199873.png' class="icon_right")
								@endif
							.info_price
								h3.info_name
									| {{$p->Product()['name'] }}
					...
					ul.list_product
						...
						li
							a.img_pro(href="https://dienmaycholon.vn/".$p->Product()->Cate()['alias']."/".$p->Product()['alias'] , target="_blank")
								...
								@endif
								@if(!empty($p['is_red_day']==4))
								img(src='https://dienmaycholon.vn/public/picture/icon/icon_desktop_4_1547192515.png' class="icon_left")
								@endif
								@if(!empty($p['is_price']==1))
								img(src='https://dienmaycholon.vn/public/picture/icon/icon_desktop_9_1547199873.png' class="icon_right")
								@endif
