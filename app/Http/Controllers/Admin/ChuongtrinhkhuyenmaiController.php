...
class ChuongtrinhkhuyenmaiController extends Controller
{
        ...
        header('Content-Type: text/html; charset=UTF-8');
    		if($request->isMethod("post")){
    			...
    			if($validater->fails()){
                    ...
                    $tenchuongtrinh =  $request->input("name_promotion");
                    $TNews->name_promotion = $tenchuongtrinh ;
    		...
    		$this->View['tenchuongtrinh'] = (!empty($tenchuongtrinh))?$tenchuongtrinh:"";
    		return view("admin.chuongtrinhkhuyenmai.themmoi",$this->View);	
    }
    ...
    public function danhsach(Request $request){
    	...
    	return view("admin.chuongtrinhkhuyenmai.danhsach",$this->View);	
    }
