...
class GrabController extends Controller
{
    ...
    public function add(Request $request){
    		...
    		return view("admin.grab.add",$this->View);	
    }
    public function edit($id,Request $request){
    		...
    		return view("admin.grab.edit",$this->View);
    }
    public function lists(Request $request){
    
            $this->View['data_list']=Grab::where('title','like','voucher-grab')->orderBy("id","DESC")->get();
        ...
        return view("admin.grab.lists",$this->View);  
    }
