...
html(lang="vi-VN")
	head
		...
		link(href="css/gian-hang-online.css" type='text/css' rel='stylesheet')
		...
		header
			.container_screen
				a(href="https://dienmaycholon.vn/" class="logodmcl" target="_blank" title="Siêu thị điện máy Chợ Lớn")
					img(src="img/logo-dmcl.png" alt="logo Siêu thị điện máy Chợ Lớn" class="animated fadeInLeft")
				.header_col
					div.header_col_banner
						img(src="img/img-left.png" alt="siêu giảm giá" class="animated fadeInLeft")
					
					div(class="header_col2")
						img(src="img/giam-50.png" alt="Giảm đến 50%" class="animated3 pulse")
						p.classtime Thời gian áp dụng còn:
						.text_coundown
						a(href='tel:02838563388' title='Tư vấn mua hàng')
							img(src="img/btn-mua-head.png" alt="Hướng dẫn mua hàng" class="animated fadeInUp" target="_blank")
