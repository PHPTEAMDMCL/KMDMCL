...
<head>
    ...
    <meta property="og:url" content="http://khuyenmai.dienmaycholon.vn/chuongtrinhdacbiet/giai-phong-hang-ton-lg">
    ...
    <link rel="stylesheet" type="text/css" href="http://khuyenmai.dienmaycholon.vn/y2019/giai-phong-hang-ton-lg/css/tv-lg.css">
    <script type="text/javascript" src="http://khuyenmai.dienmaycholon.vn/y2019/giai-phong-hang-ton-lg/js/jquery.min.js"></script>
    <script>
...
<header>
    <div class="content_tabs">
        <a class="position_logo" href="https://dienmaycholon.vn/" title="Siêu thị điện máy Chợ Lớn" target="_blank">
            <img class="animated1 fadeInDown" src="http://khuyenmai.dienmaycholon.vn/y2019/giai-phong-hang-ton-lg/img/logo-dmcl.png" alt="logo điện máy Chợ Lớn">
        </a>
        <div class="text_left">
            <img class="animated1 fadeInLeft" src="http://khuyenmai.dienmaycholon.vn/y2019/giai-phong-hang-ton-lg/img/product-left.png" alt="Samsung Galaxy giá rẻ">
        </div>
        <div class="text_right">
            <img class="animated3 pulse" src="http://khuyenmai.dienmaycholon.vn/y2019/giai-phong-hang-ton-lg/img/text-top-right.png" alt="ưu đãi samsung galaxy giảm đến 41%">
        </div>
    </div>
</header>
