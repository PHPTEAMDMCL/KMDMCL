...
<head>
    ...
    <meta property="og:url" content="http://khuyenmai.dienmaycholon.vn/chuongtrinhdacbiet/lg-chao-mung-luot-khach-55tr">
    ...
    <link rel="stylesheet" type="text/css" href="http://khuyenmai.dienmaycholon.vn/y2019/lg-chao-mung-luot-khach-55tr/css/tv-lg.css">
    <script type="text/javascript" src="http://khuyenmai.dienmaycholon.vn/y2019/lg-chao-mung-luot-khach-55tr/js/jquery.min.js"></script>
    <script>
    ...
    <script type="text/javascript">
        ...
        $(".box_cotent").children('.list_product_fire').children('li').slice(0, 8).show();
...
<header>
    <div class="content_tabs">
        <a class="position_logo" href="https://dienmaycholon.vn/" title="Siêu thị điện máy Chợ Lớn" target="_blank">
            <img class="animated1 fadeInDown" src="http://khuyenmai.dienmaycholon.vn/y2019/lg-chao-mung-luot-khach-55tr/img/logo-dmcl.png" alt="logo điện máy Chợ Lớn">
        </a>
        <div class="text_left">
            <img class="animated1 fadeInLeft" src="http://khuyenmai.dienmaycholon.vn/y2019/lg-chao-mung-luot-khach-55tr/img/product-left.png" alt="Samsung Galaxy giá rẻ">
        </div>
        <div class="text_right">
            <img class="animated3 pulse" src="http://khuyenmai.dienmaycholon.vn/y2019/lg-chao-mung-luot-khach-55tr/img/text-top-right.png" alt="ưu đãi samsung galaxy giảm đến 41%">
        </div>
    </div>
</header>
