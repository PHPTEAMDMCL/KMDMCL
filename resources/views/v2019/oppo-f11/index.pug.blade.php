...
html(lang="vi-VN")
  head
    ...
    link(href="http://khuyenmai.dienmaycholon.local/y2019/oppo-f11/css/bootstrap.min.css" type='text/css' rel='stylesheet')
    link(href="http://khuyenmai.dienmaycholon.local/y2019/oppo-f11/css/animate.css" type='text/css' rel='stylesheet')
    link(href="http://khuyenmai.dienmaycholon.local/y2019/oppo-f11/css/f11.css" type='text/css' rel='stylesheet')

    script(type='text/javascript' src='http://khuyenmai.dienmaycholon.local/y2019/oppo-f11/js/jquery.min.js')
    script(type='text/javascript' src='http://khuyenmai.dienmaycholon.local/y2019/oppo-f11/js/wow.min.js')
    script(type='text/javascript' src='http://khuyenmai.dienmaycholon.local/y2019/oppo-f11/js/bootstrap.min.js')
    script(type='text/javascript' src='http://khuyenmai.dienmaycholon.local/y2019/oppo-f11/js/sendcustomer.js')
  ...
  body
      ...
      .content_tabs
        .box_left
          a.position_logo2(href='https://dienmaycholon.vn/', title='Siêu thị điện máy Chợ Lớn', target='_blank')
            img.animated.fadeInUp(src='http://khuyenmai.dienmaycholon.local/y2019/oppo-f11/img/logo-dmcl.png', alt='logo điện máy Chợ Lớn')
          img.animated.fadeInLeft(src='http://khuyenmai.dienmaycholon.local/y2019/oppo-f11/img/img-left.png', alt='Galaxy M50')
        .box_right
          a.position_logo(href='https://dienmaycholon.vn/', title='Siêu thị điện máy Chợ Lớn', target='_blank')
            img.animated.fadeInUp(src='http://khuyenmai.dienmaycholon.local/y2019/oppo-f11/img/logo-dmcl.png', alt='logo điện máy Chợ Lớn')
          img.animated.fadeInRight.text-left.mar_20(src='http://khuyenmai.dienmaycholon.local/y2019/oppo-f11/img/tit-h2.png', alt='Oppo F11')
          img.animated.fadeInRight.mar_20(src='http://khuyenmai.dienmaycholon.local/y2019/oppo-f11/img/tbl-timer.png', alt='Thời gian đặt mua Oppo F11')
          img.animated.fadeInUp(src='http://khuyenmai.dienmaycholon.local/y2019/oppo-f11/img/gift-main.png', alt='Bộ quà tặng hấp dẫn khi mua Oppo F11')
          p.timer Áp dụng từ 
            span 29/03 - 19/04/2019
          a.btn_preorder.btn_preorderclick Đặt trước ngay
    nav
      p.text-center.p_line
        img.animated.fadeInUp(src='http://khuyenmai.dienmaycholon.local/y2019/oppo-f11/img/line.png', alt='line')
      ul.menu_top
        li
    ...
    section.black#tabContent-1
      div.boxdemo
        p
          img(src="http://khuyenmai.dienmaycholon.local/y2019/oppo-f11/img/camera-48mp.jpg" alt="Camera sau 48MP" class="wow fadeInRight")
    section.black
      div.boxdemo
        p
          img(src="http://khuyenmai.dienmaycholon.local/y2019/oppo-f11/img/sac-nhanh.jpg" alt="Hỗ trợ sạc nhanh 3.0" class="wow fadeInLeft")
    section.black
      div.boxdemo
        p
          img(src="http://khuyenmai.dienmaycholon.local/y2019/oppo-f11/img/tang-camera.jpg" alt="Camera tăng cường ở trung tâm" class="wow fadeInUp")
    section.black
      div.boxdemo
        p
          img(src="http://khuyenmai.dienmaycholon.local/y2019/oppo-f11/img/hieu-suat-vuot-troi.jpg" alt="Hiệu suất vượt trội" class="wow fadeInDown")
          ...
          #home1.tab-pane.active(role='tabpanel')
            .row
              .col-lg-6.col-md-6.col-sm-12.flex_two.wow.fadeInLeft
                img(src="http://khuyenmai.dienmaycholon.local/y2019/oppo-f11/img/f11-pro-bot.jpg" alt="F11 Pro")
                .info_price
                  span Giá dự kiến
                  br
                  strong 8.990.000 đ
                  ...
                  a(href='#tabContent-3' title='#')
                    img(src="http://khuyenmai.dienmaycholon.local/y2019/oppo-f11/img/dat-truoc-ngay.png" alt="Đặt trước ngay")
              .col-lg-6.col-md-6.col-sm-12.nonepd.wow.fadeInRight
                img(src="http://khuyenmai.dienmaycholon.local/y2019/oppo-f11/img/f11-pro-info.jpg" alt="Thông số kỹ thuật F11 Pro")

          #profile1.tab-pane(role='tabpanel')
            .row
              .col-lg-6.col-md-6.col-sm-12.flex_two
                img(src="http://khuyenmai.dienmaycholon.local/y2019/oppo-f11/img/f11-bot.jpg" alt="F11 Pro")
                .info_price
                  span Giá dự kiến
                  br
                  strong 7.490.000 đ
              ...
              .col-lg-6.col-md-6.col-sm-12.nonepd
                img(src="http://khuyenmai.dienmaycholon.local/y2019/oppo-f11/img/f11-info.jpg" alt="Thông số kỹ thuật F11 Pro")
          ...
          form#tabContent-1.info_get(action='', id='main_form', method='', name='')
            ...
            .box_datmua
              button.btn_preorder1(type='submit')
                img(src='http://khuyenmai.dienmaycholon.local/y2019/oppo-f11/img/dat-truoc-ngay.png', alt='mua ngay')
          .info_get.box_rule
            h3
              | THỂ LỆ CHƯƠNG TRÌNH
            article
    ...
    #bttop
      img.block(src='http://khuyenmai.dienmaycholon.local/y2019/oppo-f11/img/uptop.png', width='50', height='51')
      img.none(src='http://khuyenmai.dienmaycholon.local/y2019/oppo-f11/img/uptop-mb.png', width='30', height='31')
