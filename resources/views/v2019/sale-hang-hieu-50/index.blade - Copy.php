...
<html lang="vi-VN">
    <head>
        <title>Sinh nhật vàng 20 năm- Mua hàng giảm đến 50% tv, tủ lạnh, máy lạnh, máy giặt, gia dụng | Điện Máy Chợ Lớn</title>
        <meta http-equiv="content-type" content="text/html; charset=utf-8">
        <meta name="author" content=" Siêu thị điện máy Chợ Lớn ">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta name="description" content="Giải phóng hàng tồn mua hàng giảm giá đến 50% các sản phẩm tv, máy lạnh, máy giặt, tủ lạnh, gia dụng, di dộng tại Siêu thị điện máy Chợ Lớn">
        <meta content="INDEX,FOLLOW" name="robots">
        <meta property="og:locale" content="vi_VN">
        <meta property="og:type" content="product">
        <meta property="og:url" content="http://khuyenmai.dienmaycholon.vn/chuongtrinhdacbiet/sinh-nhat-20-nam">
        <meta property="og:site_name" content="Siêu thị điện máy nội thất Chợ Lớn">
        <meta property="og:title" content="Giải phóng hàng tồn - Mua hàng giảm đến 50% tv, tủ lạnh, máy lạnh, máy giặt, gia dụng tại Siêu thị điện máy Chợ Lớn">
        <meta property="og:description" content="Giải phóng hàng tồn mua hàng giảm giá đến 50% các sản phẩm tv, máy lạnh, máy giặt, tủ lạnh, gia dụng, di dộng tại Siêu thị điện máy Chợ Lớn">
        <meta property="og:image" content="https://dienmaycholon.vn/dmcl/images/sinh-nhat-20-nam-05-2019.jpg">
        ...
        <link rel="stylesheet" type="text/css" href="http://khuyenmai.dienmaycholon.vn/y2019/sinh-nhat-20-nam/css/owl.carousel.min.css" />
        <link rel="stylesheet" type="text/css" href="http://khuyenmai.dienmaycholon.vn/y2019/sinh-nhat-20-nam/css/owl.theme.default.min.css" />
        <link href="http://khuyenmai.dienmaycholon.vn/y2019/sinh-nhat-20-nam/css/animate.css" type="text/css" rel="stylesheet">
        <link href="http://khuyenmai.dienmaycholon.vn/y2019/sinh-nhat-20-nam/css/stock.css" type="text/css" rel="stylesheet">
        <script type="text/javascript" src="http://khuyenmai.dienmaycholon.vn/y2019/sinh-nhat-20-nam/js/jquery.min.js"></script>
        <script type="text/javascript" src="http://khuyenmai.dienmaycholon.vn/y2019/sinh-nhat-20-nam/js/owl.carousel.min.js"></script>
        ...
        <script type="text/javascript" src="http://khuyenmai.dienmaycholon.vn/y2019/sinh-nhat-20-nam/js/stock.js"></script>
    </head>
    <body>
        <header>
            <div class="container_screen bg_test">
                <div class="header_col">
                    <a class="logodmcl" href="https://dienmaycholon.vn/" target="_blank" title="Siêu thị điện máy Chợ Lớn">
                        <img class="animated fadeInLeft" src="http://khuyenmai.dienmaycholon.vn/y2019/sinh-nhat-20-nam/img/logo-dmcl.png" alt="logo Siêu thị điện máy Chợ Lớn">
                    </a>
                    <div class="header_col2">
                        <a class="" href="https://dienmaycholon.vn/" target="_blank" title="Siêu thị điện máy Chợ Lớn">
                            <img class="animated3 pulse" src="http://khuyenmai.dienmaycholon.vn/y2019/sinh-nhat-20-nam/img/img-right.png" alt="Giải phóng hàng tồn giảm 50% tv, gia dụng, tủ lạnh, máy lạnh, máy giặt" />
                        </a>
                    </div>
                    <div class="header_col_banner animated fadeInLeft">
                        <div class="boxbanner owl-carousel owl-theme" id="boxslide">
                            <a href="https://dienmaycholon.vn/tivi-led/tivi-led-sanco-h32t100" target="_blank" class="itemsbanner">
                                <img src="http://khuyenmai.dienmaycholon.vn/y2019/sinh-nhat-20-nam/img/pro-1.png" alt="Tivi Led SANCO - H32T100">
                            </a>
                        </div>
                        <img class="de" src="http://khuyenmai.dienmaycholon.vn/y2019/sinh-nhat-20-nam/img/de.png" alt="vòng đế">
                    </div>
                </div>
            </div>
        </header>
                ...
                <div class="box_content my_box_content<?php echo $number;?>">
                    ...
                    <ul class="list_product">
                        ...
                        foreach ($sanphantheodanhmuc as $key=>$product_info) 
                        {
                            ...
                            $_price_pro   = $product_info->discount;
                        ...
                        <li> 
                            ...
                            <div class="info_price">
                                ...
                                <div class="show_desc <?php echo $has_docquyenonline;?>">
                                    ...
                                    ?>
                                    <?php
                                    if($product_info->saleprice > 0 and $product_info->price==0)
                                    {
                                    ?>
        ...
        <div id="bttop"><img class="block" src="http://khuyenmai.dienmaycholon.vn/y2019/sinh-nhat-20-nam/img/uptop.png" width="50" height="51"><img class="none" src="http://khuyenmai.dienmaycholon.vn/y2019/sinh-nhat-20-nam/img/uptop-mb.png" width="30" height="31"></div>
    </body>
</html>