...
ul.breadcrumb
  li
    ...
    i.icon-angle-right
  li
    a(href='#') Danh sách Sản phẩm Techcombank
  li(style='float:right')
    a(href='/2018/12/techcombank' style='color:red' target='_blank') Xem trang
a.btn.btn-primary(href='/admin/techcombank/lists?change_value=1&nhom=1' style='float:right;margin-bottom:5px') Update Price
.row-fluid.sortable 
  .box.span12
      ...
      table.table.table-striped.table-bordered.bootstrap-datatable.datatable
        ...
        tbody
          ...
          tr
            ...
            td.center 
            	a.btn.btn-small.btn-primary(href="/admin/techcombank/edit/"+$ln['id']) EDIT 
            	p
            	a.click_remove.btn.btn-small.btn-success(href="/admin/techcombank/removed/"+$ln['id']+"?_token="+csrf_token()) REMOVED 
          @endforeach
          @endif
