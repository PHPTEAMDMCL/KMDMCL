...
<form action="/admin/promotion/stepone" name="" class="form-horizontal" method="post" enctype="multipart/form-data">
	<div class="box span12">
		<div class="box-header" data-original-title="">
			<h2><i class="halflings-icon white edit"></i><span class="break"></span>Tạo chương trình</h2>
			<div class="box-icon">
		...
		<div class="box-content">
				<fieldset>
				  	<div class="control-group">
					  	...
					  	<div class="controls">
					  		<input type="text" name="namelandingpage" class="span4 typeahead" id="namelandingpage">
					  	</div>
					  ...
					  <button type="submit" class="btn btn-primary">Qua bước hai</button>
